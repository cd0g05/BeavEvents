          ...
          <div class="club-box">
            <div class="club-header-row">
              ...
              <div class="table-button-box">
                ...
                <button class="table-button">RSVP</button>
                <button class="table-button">Delete Event</button>
              </div>
              
            </div>
            <div class="club-subheader-row"><p><strong>Date:</strong> May 28, 2025</p>
            <p><strong>Location:</strong> Intramural Fields</p>
            <p><strong>Total RSVPs:</strong> 29</p></div>
